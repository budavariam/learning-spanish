...
module.exports = function (eleventyConfig) {
  ...
  //   return lunr(cb)
  // });
  eleventyConfig.addJavaScriptFunction("useLunr", function (data) {
    // const lunrRegisterPipelineFn = this.lunrRegisterPipelineFn //defined in .eleventy.js
    // const splitHTMLIntoSections = this.splitHTMLIntoSections //defined in .eleventy.js
    // const cheerioLoad = this.useCheerioLoad //defined in .eleventy.js
  ...
  eleventyConfig.addJavaScriptFunction("useCheerioLoad", function (htmlContent) {
    console.log("X", htmlContent, htmlContent.length)
    return cheerio.load(htmlContent)
  });
  eleventyConfig.addJavaScriptFunction("lunrRegisterPipelineFn", function (data) {
    const { cb, lbl } = data
    return lunr.Pipeline.registerFunction(cb, lbl)
  });
